...
/datum/patron/lawful_pantheon/elysius
	name = "Elysius"
	domain = "Lawful Good: (Ascendant; Sun, Fire, Light, Permanence, Justice, Hope, and Order.)"
...
/datum/patron/lawful_pantheon/lune
	name = "Lune"
	domain = "Lawful Neutral: (Balance; The Moon, Masks, Secrets, Alteration, Nighttime, and Yearning.)"
...
/datum/patron/lawful_pantheon/prethwyn
	name = "Prethwyn"
	domain = "Lawful Neutral: (Death, Time, Fate, and Endings)"
