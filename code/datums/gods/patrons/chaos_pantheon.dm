...
/datum/patron/chaos_pantheon/rathyx
	name = "Rathyx"
	domain = "Chaotic Evil. ( Desolation, Undeath, Chaos.)"
	desc = "A once-living orc turned undead; Rathyx wishes to leave only himself and his followers standing. Burning the entire earth."
	worshippers = "Chaotic Barbarians, Evil Warriors, Tyrannical and Chaotic Schemers."
	mob_traits = list(TRAIT_SOUL_EXAMINE, TRAIT_NOSTINK)	//No stink is generic but they deal with dead bodies so.. makes sense, I suppose?
	t1 = /obj/effect/proc_holder/spell/invoked/avert
	t2 = /obj/effect/proc_holder/spell/targeted/abrogation
	t3 = /obj/effect/proc_holder/spell/targeted/churn
