...
/datum/preferences
	...
	var/static/datum/patron/default_patron = /datum/patron/lawful_pantheon/elysius
				...
				if("virtue")
					...
					for (var/path as anything in GLOB.virtues)
						...
						if (V.name == virtue.name || V.name == virtuetwo.name)
							continue
						if (istype(V, /datum/virtue/heretic) && !istype(selected_patron, /datum/faith/evil_pantheon))
							continue
