...
/datum/outfit/job/roguetown/monk/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		if(H.patron?.type == /datum/patron/neutral_pantheon/yamais)
		...
		if(H.patron?.type == /datum/patron/good_pantheon/viriitri)
			ADD_TRAIT(H, TRAIT_GOODLOVER, TRAIT_GENERIC)
		if(H.patron?.type == /datum/patron/good_pantheon/abyssia)
